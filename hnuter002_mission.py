...
class HnuterController:
    def __init__(self, model_path: str = "scene.xml"):
        ...
        self.KR = np.array([5.0, 3.0, 3.0])   # 姿态增益
        self.Domega = np.array([1.5, 1.0, 2.0])  # 角速度阻尼
    ...
    def _get_actuator_ids(self):
        ...
        # 推力执行器
        self.thrust_actuators = ['motor_r_lower', 'motor_r_upper', 'motor_l_lower', 'motor_l_upper', 'motor_rear_upper']
